    ...
    <>
      <div className="p-8 bg-gray-50">
        ...
        <p className="text-lg text-gray-600 mb-8 text-center">
          ...
          opportunities available in the market today. Whether you are looking
          to step into a new role or advance your career, these positions offer
          competitive packages and are with leading companies across various
          industries. Explore these openings to find your next career move and
          get ahead in your professional journey.
        </p>
